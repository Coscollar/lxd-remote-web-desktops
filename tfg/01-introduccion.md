...
El beneficio de la plataforma se concreta por perfil de usuario. El **alumno** deja de depender del aula: abre su escritorio desde cualquier dispositivo con navegador y guarda o restaura su trabajo de forma autónoma, sin intervención del profesor. <!-- fuente: docs/USO.md:Para el alumno --> El **profesor o administrador** gestiona todo desde una consola web —matricula alumnos, crea laboratorios, destruye instancias— sin administrar contraseñas de alumnos, gracias a la autenticación por enlaces de un solo uso. <!-- fuente: docs/USO.md:Para el administrador --> La **institución** concentra en un único servidor los entornos que antes exigían un equipo por puesto —dentro de las cotas que cuantifica el Capítulo 7—, con software libre y sin coste de licencia. <!-- fuente: README.md:Qué es, README.md:Cotas -->

El trabajo se alinea con tres Objetivos de Desarrollo Sostenible de la Agenda 2030 (Naciones Unidas, 2015): con el **ODS 4 (educación de calidad)**, porque extiende el acceso a entornos de prácticas configurados más allá del horario y el espacio del aula; con el **ODS 10 (reducción de las desigualdades)**, porque reduce al mínimo el hardware exigido al alumno, que accede desde cualquier equipo al mismo escritorio Linux ejecutado en el servidor; y con el **ODS 12 (producción y consumo responsables)**, porque consolida en una sola máquina los recursos que de otro modo exigirían un equipo por puesto, con instancias que se autodestruyen al dejar de usarse. <!-- fuente: [ELABORAR: redacción ODS justificada, no listada] -->
